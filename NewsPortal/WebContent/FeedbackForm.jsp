...
<body bgcolor="#ADD8E6">
	...
	<div class="container">
		<ul>
			<a href="Home.jsp"> <li class="roundbox">Book An Appointment</li></a>
	...
	<h1>Feedback Form</h1>
		...
		<form action="Feedbackdb" method="get">
				...
				placeholder="Your name.." required="required">
				 ...
				 <label	class="size">Email</label> <input readonly="readonly" name="email" value=<%=email%> placeholder="abc@xyz.com" required="required">
		   		
		   		<label class="size">Contact</label> <input type="tel" name="contact" placeholder="xxxxxxxx" pattern="^\d{10}$"	 required="required">
