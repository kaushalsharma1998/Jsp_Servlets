...
<body bgcolor="#ADD8E6">
	...
	<div class="container">
		...
		<hr>
		<form action="AddReporter" method="post">
			<div class="reg">
				<table>
					<tr>
						<td></td>
					...
					<tr>
						<td>Contact No:</td>
						<td><input type="number" name="contact" placeholder="xxxxxxxxx"
					...
					<tr>
						<td>Address</td>
						<td><textarea rows="3
						" cols="40" name="addesss" placeholder="Enter Address" required="required"></textarea></td>
					</tr>
					<tr>
